    ...
    <section id='one'>
      <div class='inner pa'>
        ...
        <ul class='m-elements'>
          ...
          <li>
            <strong>IONOS by 1&1: </strong>Leistungen auf dem Gebiet der
        ...
        <ul class='m-elements'>
          <li>
            ...
            wartungsfreien und effizienten Nutzung von Schriftarten im Hinblick
            auf Aktualität und Ladezeiten, deren einheitliche Darstellung und
            Berücksichtigung möglicher lizenzrechtlicher Beschränkungen. Google
            wird die IP-Adresse des Nutzers mitgeteilt, damit Google die
            Schriften im Browser der Nutzer bereitstellen kann. Darüber hinaus
            werden technische Daten (Spracheinstellungen, Bildschirmauflösung,
            Betriebssystem, verwendete Hardware) übermittelt, die für die
            Bereitstellung der Schriftarten in Abhängigkeit von den verwendeten
            Geräten und der technischen Umgebung erforderlich sind. ;
            <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon
            House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google
            LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA;
            <strong>Website:</strong>
          ...
          <li>
            ...
            werden; <strong>Dienstanbieter:</strong> Google Ireland Limited,
