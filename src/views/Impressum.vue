  ...
  <div id="main" class="alt">
    <section id="one">
      <div class="inner">
        ...
        <p>
          E-Mail:
          <a href="mailto:contact@clublive.band">
            contact@clublive.band
          </a>
        </p>
        ...
        <ul>
          <li>
            Website-Betreiber: <a href="https://www.ionos.de/">IONOS</a>,
            Kontakt: 0721 / 9605727 oder
            <a href="https://www.1und1.de/Kontakt">Kontaktformular </a>
          </li>
          <li>
            <a href="https://www.google.com/intl/de/contact/"> Google Fonts </a
            >: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043
            USA
          </li>
          <li>
            <a href="https://www.youtube.com/t/contact_us?hl=de&amp;gl=DE"
              >YouTube</a
